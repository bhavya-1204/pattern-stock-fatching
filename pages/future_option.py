...
st.set_page_config(page_title="Daily f&O Scanner", layout="wide")

st.title("📊 Daily F&O Pattern Scanner")
st.caption("Auto-updated after GitHub Actions run")

# 🔁 Auto refresh every 2 minutes
st_autorefresh(interval=120_000, key="refresh")

CSV_URL = f"https://raw.githubusercontent.com/bhavya-1204/pattern-stock-fetching/master/output/future_output.csv"
